// This file should only be included in a local namespace, for which
// every quantity is real. There is no include-guard, so make sure to
// include only once for a particular namespace.
