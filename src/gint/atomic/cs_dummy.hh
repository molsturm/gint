...
namespace cs_dummy {
  ...
  template <typename StoredMatrix> class JIntegralCore;
  template <typename StoredMatrix> class KIntegralCore;
  ...
  Integral<StoredMatrix >IntegralCollection<StoredMatrix>::operator()(const std::string& integral_name)
  {
    ...
    if(integral_name == "coulomb")            return Integral<StoredMatrix>{make_unique<JIntegralCore<stored_matrix_type>>(integral_calculator,k_exponent)};  
    if(integral_name == "exchange")           return Integral<StoredMatrix>{make_unique<KIntegralCore<stored_matrix_type>>(integral_calculator,k_exponent)};
...
public:
  ...
  KineticIntegralCore(const Atomic& integral_calculator, real_type k) : k(k), m_integral_calculator(integral_calculator) { }
...
public:
    ...
    JIntegralCore(const Atomic& integral_calculator, real_type k) : k(k), m_integral_calculator(integral_calculator) { }
  ...
  public:
    ...
    KIntegralCore(const Atomic& integral_calculator, real_type k) : k(k), m_integral_calculator(integral_calculator) { }
