...
class IntegralCollection final
 ...
 public:
  ...
  sturmint::atomic::cs_reference_pc::Atomic integral_calculator;
...
class NuclearAttractionIntegralCore : public IntegralCoreBase<real_stored_mtx_type> {
 public:
  ...
  NuclearAttractionIntegralCore(
        const sturmint::atomic::cs_reference_pc::Atomic& integral_calculator, real_type k,
        real_type Z)
        : k(k),
          Z(Z),
...
//   static_assert(false, "Need GINT_ENABLE_STATIC_INTEGRALS=ON for cs_reference_pc for now.");
// #endif
