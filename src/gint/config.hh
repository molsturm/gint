...
//typedef linalgwrap::MultiVector<const linalgwrap::MutableMemoryVector_i<real_type> > const_real_multivector_type;
//typedef linalgwrap::MultiVector<linalgwrap::MutableMemoryVector_i<real_type> >             real_multivector_type;
